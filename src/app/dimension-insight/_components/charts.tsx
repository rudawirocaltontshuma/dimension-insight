...
import { formatCompact } from "@/data/dimension-insight/format";
...
export function DimensionInsightLineChart({
  data,
  series,
  xKey,
  height = "h-72",
...
export function DimensionInsightAreaChart({
  data,
  series,
  xKey,
  height = "h-72",
...
export function DimensionInsightBarChart({
  data,
  series,
  xKey,
  height = "h-72",
...
export function DimensionInsightPieChart({
  data,
  nameKey = "name",
  valueKey = "value",
  height = "h-72",
...
export function DimensionInsightScatterChart({
  data,
  xKey,
  yKey,
  zKey,
...
export function DimensionInsightComposedChart({
  data,
  series,
  xKey,
  height = "h-72",
...
export function DimensionInsightFunnelChart({
  data,
  height = "h-72",
  className,
}: {
...
export function DimensionInsightSparkline({ values, positive = true }: { values: number[]; positive?: boolean }) {
