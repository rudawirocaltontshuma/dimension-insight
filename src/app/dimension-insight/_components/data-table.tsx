...
export type DimensionInsightColumn<T extends RowData> = ColumnDef<DataTableFeatures, T>;
...
interface DimensionInsightDataTableProps<T extends RowData> {
  data: T[];
  columns: DimensionInsightColumn<T>[];
...
export function DimensionInsightDataTable<T extends RowData>({
  data,
  columns,
  ...
  showSearch = true,
  className,
}: DimensionInsightDataTableProps<T>) {
