...
import { REPORTS } from "@/data/dimension-insight/content";
import { CURRENT, delta, MONTHLY, PREVIOUS } from "@/data/dimension-insight/datasets";
import { formatCurrency, formatDate, formatNumber, formatPercent } from "@/data/dimension-insight/format";
...
export default async function ReportDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      <Link
        href="/dimension-insight/reports"
