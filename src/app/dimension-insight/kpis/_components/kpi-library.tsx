...
import { KPIS, type KpiDefinition, kpiStatus, kpiTrend, kpiVariance } from "@/data/dimension-insight/content";
import { formatCurrency, formatNumber, formatPercent, formatSigned } from "@/data/dimension-insight/format";
import type { DataTableFeatures } from "@/lib/data-table-features";
import { cn } from "@/lib/utils";

import { DimensionInsightLineChart, DimensionInsightSparkline } from "../../_components/charts";
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center gap-2">
              <DimensionInsightSparkline values={row.original.history} positive={trend >= 0} />
              <span
                className={cn(
