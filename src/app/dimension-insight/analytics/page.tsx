...
import { DimensionInsightAreaChart, DimensionInsightBarChart } from "../_components/charts";
    ...
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <div className="grid min-w-0 grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <ChartCard title="Order volume" description="Closed order count by period">
          <DimensionInsightBarChart data={TREND} series={[{ key: "orders", label: "Orders" }]} xKey="label" />
        </ChartCard>
      </div>
