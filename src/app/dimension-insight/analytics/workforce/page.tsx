...
import { DEPARTMENT_PERFORMANCE } from "@/data/dimension-insight/aggregates";
import { CURRENT, delta, EMPLOYEES, MONTHLY, PREVIOUS } from "@/data/dimension-insight/datasets";
    ...
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <div className="grid min-w-0 grid-cols-1 gap-4 xl:grid-cols-2">
        <ChartCard title="Headcount" description="Total headcount across the trailing 24 periods">
          <DimensionInsightAreaChart data={TREND} series={[{ key: "headcount", label: "Headcount" }]} xKey="label" />
        </ChartCard>
