...
import { REGIONS } from "@/data/nexora/dimensions";
  ...
  const filterFields = (
    <>
      <div className="space-y-1.5">
        <Label htmlFor="nexora-period">Reporting period</Label>
        <Select value={period} onValueChange={setPeriod}>
          <SelectTrigger id="nexora-period" className="w-full">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {PERIODS.map((item) => (
      ...
      <div className="space-y-1.5">
        <Label htmlFor="nexora-region">Region</Label>
        <Select value={region} onValueChange={setRegion}>
          <SelectTrigger id="nexora-region" className="w-full">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-1.5">
        <Label htmlFor="nexora-segment">Segment</Label>
        <Select value={segment} onValueChange={setSegment}>
          <SelectTrigger id="nexora-segment" className="w-full">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {SEGMENTS.map((item) => (
      ...
      <div className="space-y-1.5">
        <Label htmlFor="nexora-currency">Reporting currency</Label>
        <Select value={currency} onValueChange={setCurrency}>
          <SelectTrigger id="nexora-currency" className="w-full">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {CURRENCIES.map((item) => (
