...
import { NEXORA_BASE } from "../_lib/navigation";
      ...
      <div className="flex w-full items-center justify-between gap-2 px-3 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            onClick={() => toast.info("NEXORA INSIGHT is a frontend demonstration using fictional data.")}
          >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <DropdownMenuItem asChild>
                <Link href={`${NEXORA_BASE}/saved-views`}>Saved views</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href={`${NEXORA_BASE}/settings`}>Workspace settings</Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
