...
import { CUSTOMER_SEGMENT_BREAKDOWN } from "@/data/nexora/aggregates";
import { CURRENT, CUSTOMERS, delta, MONTHLY, PREVIOUS } from "@/data/nexora/datasets";
import { formatCurrency, formatNumber, formatPercent } from "@/data/nexora/format";

import { NexoraAreaChart, NexoraBarChart, NexoraLineChart, NexoraPieChart } from "../../_components/charts";
    ...
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <div className="grid min-w-0 grid-cols-1 gap-4 xl:grid-cols-2">
        <ChartCard title="Customer growth" description="Active customer base across the trailing 24 periods">
          <NexoraAreaChart data={TREND} series={[{ key: "customers", label: "Customers" }]} xKey="label" />
        </ChartCard>

        <ChartCard title="Acquisition" description="New logos acquired per period">
          <NexoraBarChart data={TREND} series={[{ key: "newCustomers", label: "New customers" }]} xKey="label" />
        </ChartCard>
