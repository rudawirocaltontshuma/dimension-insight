...
import { PIPELINE_BY_STAGE, REGIONAL_PERFORMANCE, REVENUE_BY_REGION, TOP_PRODUCTS } from "@/data/nexora/aggregates";
...
import { NexoraBarChart, NexoraComposedChart, NexoraFunnelChart, NexoraLineChart } from "../../_components/charts";
    ...
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <div className="grid min-w-0 grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <ChartCard title="Pipeline" description="Weighted opportunity value by sales stage">
          <NexoraFunnelChart data={PIPELINE_BY_STAGE.map((stage) => ({ name: stage.name, value: stage.value }))} />
        </ChartCard>
