...
import { SAVED_VIEWS, type SavedView } from "@/data/nexora/content";
import { formatDate } from "@/data/nexora/format";

const MODULES = [
  { label: "Executive Dashboard", href: "/nexora/dashboard" },
  { label: "Sales Analytics", href: "/nexora/analytics/sales" },
  { label: "Finance Analytics", href: "/nexora/analytics/finance" },
  { label: "Customer Analytics", href: "/nexora/analytics/customers" },
  { label: "Operations Analytics", href: "/nexora/analytics/operations" },
  { label: "Marketing Analytics", href: "/nexora/analytics/marketing" },
  { label: "Workforce Analytics", href: "/nexora/analytics/workforce" },
  { label: "Data Explorer", href: "/nexora/data-explorer" },
];
